    ...
    const vector<float> terrain_y)
{
    ...
    // std::cout<<root_position.x<<" "<<root_position.y<<" " <<root_position.z<< " "<<std::endl;
    // std::cout<<root_body_position.x<< " "<<root_body_position.y<< " "<<root_body_position.z<<" " <<std::endl;
    // std::cout<<std::endl;
    // cur_root_height = 
...
int main(void)
{
    ...
    ifstream file("resources/terrain_data_so.txt");
    if (!file.is_open()) {
    ...
    Image image = LoadImage("resources/heightmap_so.png");     // Load heightmap image (RAM)
    ...
    // float feature_weight_contact = 1.5f;
    ...
    auto update_func = [&]()
    {
        ...
        // std::cout<<"num features:" <<db.nfeatures()<<std::endl;
